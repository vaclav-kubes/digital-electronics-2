...
#define LED_EXT_G PB0    // External active-low LED
#define LED_EXT_B PB1    // External active-low LED
...
int main(void)
{
    ...
    GPIO_mode_output(&DDRB, LED_EXT_B);
    GPIO_mode_output(&DDRB, LED_EXT_G);
